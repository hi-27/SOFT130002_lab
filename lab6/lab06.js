...
testMail("18049777815", "19302010067@fudan.edu.cn");
/*
3.
要求：
...
function DevelopingCountry() {
    ...
    if(typeof this.sayHi != "function")
        DevelopingCountry.prototype.sayHi = function(){ console.log("Hi, i am " + DevelopingCountry.name); };
}
...
function PoorCountry(){
    this.name = "a poor country";//这行好像没什么用
